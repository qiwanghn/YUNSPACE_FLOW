        ...
        $("[issubflowtable='1']").each(function ()
        {
            ...
            if (!primarytablefiledvalue)
            {
                ...
                for (var i = 0; i < $ctls.size() ; i++)
                {
                    ...
                    var subvalidate = formrun.initFlowControl(subtype, $ctl, $ctl.val(), valtype, subfieldstatus);
            ...
            {
                var ajaxUrl = top.rootdir + "/WorkFlowFormDesigner/GetSubTableData?secondtable=" + secondtable + "&primarytablefiled=" + primarytablefiled +
